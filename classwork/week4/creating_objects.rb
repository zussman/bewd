...
#Why use Objects?
# => Follow along with the instructor, comment out code and run the file to test your assumptions.
#TIME: 45 min
...
class Student
  ...
  #Someone asked a question about giving multiple students an F for cheating on each other. Andrei says this would be a weird way of going about this though...
  def fail!(another_student)
    @grade = 'F'
    another_student.grade = 'F'
  end
